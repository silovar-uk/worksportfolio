...
const jsAssets = [
  ...
  'shelf-priority.js', 'favorites.js', 'copy-cleanup.js', 'friction-atlas.js', 'live-index.js'
];
...
for (const asset of ['shelf-priority.js', 'floating-random.js', 'random-three.js', 'comparison-view.js', 'favorites.js', 'friction-atlas.js', 'live-index.js']) {
