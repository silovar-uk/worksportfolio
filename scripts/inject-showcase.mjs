...
const taxonomy = await readJson('data/portfolio-taxonomy.json');
...
console.log('Injected Project Family / Making Principle taxonomy as data only; no Showcase runtime shipped.');
