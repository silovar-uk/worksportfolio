...
const curated = {
  ...
  l1l5analysis: {
    ...
    icon: '↕️', type: 'learning-tool', verbs: ['読む', '分析する', '書く'], status: 'active', visibility: 'public', featured: false, editorialState: 'published',
  ...
  'urawa-history-quiz': {
    ...
    icon: '♦️', type: 'learning-tool', verbs: ['解く', '学ぶ', 'つなげる'], status: 'development', visibility: 'public', featured: false, editorialState: 'published',
